...
stock.list <- c("cod.27.7e-k",  "had.27.7b-k","whg.27.7b-ce-k","meg.27.7b-k8abd", "mon.27.78abd", "sol.27.7fg") 
...
SRs <- list(`cod.27.7e-k` = COD.sr, `had.27.7b-k` = HAD.sr, `whg.27.7b-ce-k` = WHG.sr, `meg.27.7b-k8abd` = MEG.sr, `mon.27.78abd` = MON.sr, `sol.27.7fg` = SOL.sr  ) #  
range(SRs[[1]])[4] <- 1980
range(SRs[[1]])[5] <- 2022
```
...
growth.model     <- ifelse(!Baranov, c(`cod.27.7e-k`='ASPG', `had.27.7b-k`='ASPG', `whg.27.7b-ce-k`='ASPG', `meg.27.7b-k8abd`='ASPG', `mon.27.78abd`='ASPG', `sol.27.7fg`='ASPG'), 
                           
                           c(`cod.27.7e-k` = "ASPG_Baranov", `had.27.7b-k` = "ASPG_Baranov", `whg.27.7b-ce-k` = "ASPG_Baranov", `meg.27.7b-k8abd` = "ASPG_Baranov", `meg.27.7b-k8abd` = "ASPG_Baranov", `mon.27.78abd` = "ASPG_Baranov", `sol.27.7fg` = "ASPG_Baranov")) ; names(growth.model) <- 
  
  c("cod.27.7e-k", "had.27.7b-k", "whg.27.7b-ce-k", "meg.27.7b-k8abd", "mon.27.78abd", "sol.27.7fg")
...
c.mod$catch.mod<-sapply(c.mod$values,function(x) {
  if(x %in% c("cod.27.7e-k", "had.27.7b-k", "whg.27.7b-ce-k", "meg.27.7b-k8abd", "mon.27.78abd",  "sol.27.7fg" )) return("CobbDouglasAge") else
