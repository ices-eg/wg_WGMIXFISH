...
#catchNames(fleets) <- "cod.27.7e-k" # CM - added this so it would run! Previous warning - subscript out of bounds
#st <- "cod.27.7e-k"
#fl <- "cod.27.7e-k"
# Q Paul - below dosen't work but I am not sure I need it
for(st in stks){
...
for(fl in names(fleets)) { fleets.ctrl.COD[[fl]][["effort.restr"]] <- 'COD'}
...
#NOTE CM - need to add extra years
...
cod.fb$discards[cod.fb$stock== "COD"] <- cod.fb$catch[cod.fb$stock== "COD"] - cod.fb$landings[cod.fb$stock== "COD"]  
