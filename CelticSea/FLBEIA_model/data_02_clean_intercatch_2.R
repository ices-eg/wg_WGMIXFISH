...
# 01 - Reading in Caton ####
taf.unzip("bootstrap/data/ices_intercatch/2020 06 22 WGMIXFISH CATON Stocks with distributions all WG 2002  2019.zip", files="2020 06 22 WGMIXFISH CATON stocks with distributions all WG 2002 2019.csv", exdir=file.path(Data_path,"data/ices_intercatch"))
#NB gitignore this file as it is too big
intercatch_caton <-  read.csv(file = file.path(Data_path,"data/ices_intercatch/2020 06 22 WGMIXFISH CATON stocks with distributions all WG 2002 2019.csv"),fileEncoding = "UTF-8-BOM")
