...
#### yv fix the stock object doesnot have discrads nor catches which is a pb when runing make fleet / same in 2020
...
# *** In FLBEIA, it's important to have weights and numbers for landings, discards and catch. *** NEEDS UPDATING
...
# adjust catch data (plus wt, n)
stock@catch[,ac(2019)] <- 2154
stock@catch.wt[,ac(2019)] <- stock@catch.wt[,ac(2018)]
stock@catch.n[,ac(2019)] <- stock@catch[,ac(2019)] / stock@catch.wt[,ac(2019)] 

stock@landings[,ac(2019)] <- 1172
stock@landings.wt[,ac(2019)] <- stock@landings.wt[,ac(2018)]
...
stock@discards.wt[,ac(2019)] <- stock@discards.wt[,ac(2018)]
stock@discards.n[,ac(2019)] <- stock@discards[,ac(2019)] / stock@discards.wt[,ac(2019)] 

# make assumptions for stock
stock@stock.wt <- stock@catch.wt # assumed to be the
stock@stock.n <- stock@catch.n * 10 # for non-TV survey stocks, we just make a high estimate of numbers
stock@stock <- computeStock(stock)
stock@mat[1] <- 1


# double check harvest units
units(harvest(stock)) <- "hr"
...
stock@catch.wt[,ac(2019)] <- weighted.mean(
  x = c(c(stock@landings.wt[,ac(2019)]), c(stock@discards.wt[,ac(2019)])), 
  w = c(c(stock@landings[,ac(2019)]), c(stock@discards[,ac(2019)]))
)
stock@catch.n[,ac(2019)] <- stock@catch[,ac(2019)] / stock@catch.wt[,ac(2019)] 
...
stock@catch.n[,ac(2019)] / stock@stock.n[,ac(2019)] # should be similar to above

stock@stock.wt <- stock@catch.wt # assume stock.wt equals catch.wt
stock@stock <- stock@stock.wt * stock@stock.n
stock@mat[1] <- 1
...
stock@catch.n[,ac(2019)] / stock@stock.n[,ac(2019)] # should be close to above
...
stock@landings.n[,ac(2019)] <- stock@landings[,ac(2019)] / stock@landings.wt[,ac(2019)] # assumed

stock@catch[,ac(2019)] <- stock@landings[,ac(2019)]
stock@catch.wt[,ac(2019)] <- stock@landings.wt[,ac(2019)] ### assumed
stock@catch.n[,ac(2019)] <- stock@catch[,ac(2019)] / stock@catch.wt[,ac(2019)] # assumed

stock@discards[,ac(2017:2019)] <- stock@catch[,ac(2017:2019)] - stock@landings[,ac(2017:2019)] # assumed
stock@discards.wt[,ac(2019)] <- stock@discards.wt[,ac(2018)] # assumed
stock@discards.n[,ac(2019)] <- 0 # assumed
...
stock@landings.wt[,ac(2019)] <- stock@landings.wt[,ac(2018)] # assumed
stock@landings.n[,ac(2019)] <- stock@landings[,ac(2019)] / stock@landings.wt[,ac(2019)] # assumed

stock@catch[,ac(2019)] <- stock@landings[,ac(2019)]
stock@catch.wt[,ac(2019)]  <- stock@catch.wt[,ac(2018)] # assumed
stock@catch.n[,ac(2019)] <- stock@catch[,ac(2019)] / stock@catch.wt[,ac(2019)] # assumed

stock@discards[,ac(2018:2019)] <- stock@catch[,ac(2018:2019)] - stock@landings[,ac(2018:2019)] # assumed
stock@discards.wt[,ac(2019)] <- stock@discards.wt[,ac(2018)] # assumed
stock@discards.n[,ac(2019)] <- 0 # assumed
...
stock@discards[,ac(2017:2019)] <- stock@catch[,ac(2017:2019)] - stock@landings[,ac(2017:2019)] # assumed
stock@discards.wt[,ac(2017:2019)] <- stock@discards.wt[,ac(2016)] # assumed
stock@discards.n[,ac(2017:2019)] <- 0 # assumed
...
stock@discards[,ac(2019)] <- stock@catch[,ac(2019)] - stock@landings[,ac(2019)] # assumed
stock@discards.wt[,ac(2019)] <- stock@discards.wt[,ac(2018)] # assumed
stock@discards.n[,ac(2017:2019)] <- 0 # assumed
...
stock@landings.wt[] <- 40 # assumed
stock@discards.wt[] <- 40 # assumed
stock@catch.wt[] <- 40 # assumed

stock@landings.n[] <- stock@landings[] / stock@landings.wt[] # assumed
stock@catch.n[] <- stock@catch[] / stock@catch.wt[] # assumed
stock@discards.n[] <- stock@discards[] / stock@discards.wt[] # assumed
